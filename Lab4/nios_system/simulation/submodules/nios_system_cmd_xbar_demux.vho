...
--synthesis_resources = 
 ...
 ENTITY  nios_system_cmd_xbar_demux IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END RTL; --nios_system_cmd_xbar_demux
