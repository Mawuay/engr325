...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "C:/altera/13sp1/quartus/"
} 
...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/submodules/nios_system_RAM.hex ./
...
ensure_lib                                                                          ./libraries/BRIDGE_avalon_slave_translator_avalon_universal_slave_0_agent_rsp_fifo  
vmap       BRIDGE_avalon_slave_translator_avalon_universal_slave_0_agent_rsp_fifo   ./libraries/BRIDGE_avalon_slave_translator_avalon_universal_slave_0_agent_rsp_fifo  
...
alias com {
  ...
  vcom  "$QSYS_SIMDIR/submodules/nios_system_BRIDGE_avalon_slave_translator_avalon_universal_slave_0_agent_rsp_fifo.vho"   -work BRIDGE_avalon_slave_translator_avalon_universal_slave_0_agent_rsp_fifo  
  ...
  vcom  "$QSYS_SIMDIR/submodules/nios_system_BRIDGE.vhd"                                                                   -work BRIDGE                                                                  
  vcom  "$QSYS_SIMDIR/submodules/nios_system_RAM.vhd"                                                                      -work RAM                                                                     
  vcom  "$QSYS_SIMDIR/submodules/nios_system_CPU.vho"                                                                      -work CPU                                                                     
  ...
  vcom  "$QSYS_SIMDIR/submodules/nios_system_CPU_mult_cell.vhd"                                                            -work CPU                                                                     
  ...
  vcom  "$QSYS_SIMDIR/nios_system_ram_s1_translator.vhd"                                                                                                                                                 
  vcom  "$QSYS_SIMDIR/nios_system_bridge_avalon_slave_translator.vhd"                                                                                                                                    
  vcom  "$QSYS_SIMDIR/nios_system_cpu_jtag_debug_module_translator_avalon_universal_slave_0_agent.vhd"                                                                                                   
  vcom  "$QSYS_SIMDIR/nios_system_bridge_avalon_slave_translator_avalon_universal_slave_0_agent.vhd"                                                                                                     
...
alias elab {
  echo "\[exec\] elab"
  vsim +access +r  -t ps -L work -L irq_mapper -L width_adapter -L rsp_xbar_mux -L rsp_xbar_demux -L cmd_xbar_mux -L cmd_xbar_demux_001 -L cmd_xbar_demux -L rst_controller -L burst_adapter -L limiter -L id_router_002 -L id_router -L addr_router -L BRIDGE_avalon_slave_translator_avalon_universal_slave_0_agent_rsp_fifo -L CPU_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo -L CPU_jtag_debug_module_translator_avalon_universal_slave_0_agent -L CPU_instruction_master_translator_avalon_universal_master_0_agent -L CPU_jtag_debug_module_translator -L CPU_instruction_master_translator -L BRIDGE -L RAM -L CPU -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneii_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneii $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  vsim -dbg -O2 +access +r -t ps -L work -L irq_mapper -L width_adapter -L rsp_xbar_mux -L rsp_xbar_demux -L cmd_xbar_mux -L cmd_xbar_demux_001 -L cmd_xbar_demux -L rst_controller -L burst_adapter -L limiter -L id_router_002 -L id_router -L addr_router -L BRIDGE_avalon_slave_translator_avalon_universal_slave_0_agent_rsp_fifo -L CPU_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo -L CPU_jtag_debug_module_translator_avalon_universal_slave_0_agent -L CPU_instruction_master_translator_avalon_universal_master_0_agent -L CPU_jtag_debug_module_translator -L CPU_instruction_master_translator -L BRIDGE -L RAM -L CPU -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneii_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneii $TOP_LEVEL_NAME
}
