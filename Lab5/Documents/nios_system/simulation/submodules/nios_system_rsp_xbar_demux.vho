...
--synthesis_resources = 
 ...
 ENTITY  nios_system_rsp_xbar_demux IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END nios_system_rsp_xbar_demux;

 ARCHITECTURE RTL OF nios_system_rsp_xbar_demux IS
 ...
 END RTL; --nios_system_rsp_xbar_demux
