...
JDI_FILE := H:/SeniorYear/ENGR325/Lab/Lab8/Lab8/Lab8.jdi

# Qsys--generated SOPCINFO file. Required for resolving node instance ID's with 
# design component names. 
SOPCINFO_FILE := H:/SeniorYear/ENGR325/Lab/Lab8/Lab8/nios_system.sopcinfo
...
# setting hal.stderr is JTAGUART
ELF_PATCH_FLAG  += --stderr_dev JTAGUART

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is JTAGUART
ELF_PATCH_FLAG  += --stdin_dev JTAGUART
...
# setting hal.stdout is JTAGUART
ELF_PATCH_FLAG  += --stdout_dev JTAGUART
